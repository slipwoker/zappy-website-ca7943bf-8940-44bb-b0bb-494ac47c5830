document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (isRequired && value === '') {
        ...
        const fieldName = label ? label.textContent.replace('*', '').trim() : name;
  ...
  // ============================================================
  const animatedElements = document.querySelectorAll('.fade-in, .slide-up, .slide-in-left, .slide-in-right, [data-animate]');
  ...
  if (animatedElements.length > 0) {
    ...
    style.textContent = [
      '.animate-hidden { opacity: 0; transform: translateY(24px); transition: opacity 0.6s ease, transform 0.6s ease; }',
      '.animate-hidden.slide-in-left { transform: translateX(-40px); }',
      '.animate-hidden.slide-in-right { transform: translateX(40px); }',
      '.animate-visible { opacity: 1 !important; transform: translate(0, 0) !important; }'
    ].join('\n');
...
const zappyAdditionalDefaultLanguage = "en";
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ca7943bf-8940-44bb-b0bb-494ac47c5830',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ca7943bf-8940-44bb-b0bb-494ac47c5830';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ca7943bf-8940-44bb-b0bb-494ac47c5830';
